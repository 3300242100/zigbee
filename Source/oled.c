...
static const unsigned char Fchinese[][32] = {
...
{0x04,0x04,0x7E,0x01,0x44,0x48,0x50,0x7F,0x40,0x40,0x7F,0x50,0x48,0x44,0x40,0x00},/*"转",2*/
/* (16 X 16 , 宋体 )*/

{0x40,0x40,0x42,0xcc,0x00,0x04,0xf4,0x94,0x94,0xff,0x94,0x94,0xf4,0x04,0x00,0x00},
{0x00,0x40,0x20,0x1f,0x20,0x48,0x44,0x42,0x41,0x5f,0x41,0x42,0x44,0x48,0x40,0x00},/*"速",3*/
/* (16 X 16 , 宋体 )*/

{0x10,0x0c,0x05,0x55,0x55,0x55,0x05,0x7f,0x05,0x55,0x55,0x55,0x05,0x14,0x0c,0x00},
{0x80,0x40,0x3f,0x11,0x15,0xf5,0x95,0x15,0x15,0x35,0x55,0x55,0xb5,0x91,0x80,0x00},/*"震",4*/
/* (16 X 16 , 宋体 )*/
...
void OLED_ShowCHinese(unsigned char x,unsigned char y,unsigned char no)
{
  unsigned char t, adder = 0;
	...
	for (t = 0; t < 16; t++)
	{
		OLED_WrDat(Fchinese[2 * no][t]);
		adder += 1;
	}
	OLED_Set_Pos(x, y + 1);
	for (t = 0; t < 16; t++)
	{
		OLED_WrDat(Fchinese[2 * no + 1][t]);
		adder += 1;
	}
}
#endif
